                         ...
                         >
                                { plan.popular && (
                                    <div className="text-center mb-4">
                                        <span className="bg-blue-600 text-white text-xl py-1 px-3 rounded-full uppercase">
                                ...
                                <ul className="mb-8 space-y-2 text-neutral-400">
                                    {plan.features.map( (feature, i) => (
                                        <li key={i} className="flex items-center">
                                            <span className=" w-2 h-2 bg-neutral-600 rounded-full mr-2">
                                            </span>
                                            {feature}
                                        </li>
                                    ))}
