...
const HeroSection = () => {
  ...
  return (
    <motion.section 
        ...
        <div className="max-w-7xl mx-auto px-4 flex flex-col justify-center items-center text-center">
            <motion.div 
                variants={fadeInup}
            ...
            tracking-tighter bg-gradient-to-b from-neutral-50
            ...
            <motion.div 
               ...
               <a href="#" className="inline-block border border-blue-900 
               hover:border-blue-500 text-white py-3 px-6 rounded-lg font-medium">
